...
class brandItemWindow():
    ...
    def __init__(self,arg1):
        ...
        self.addButton=[['ADD BRAND',[70,250],[4,10]],
                        ['ADD ITEM',[270,250],[4,11]],
                        ['CHANGE ITEM',[470,250],[4,11]]]
    ...
    def addItem(self):
        if self.itemObject.brandVal == None:
            messagebox.showinfo('Uma Store','Select a Brand to add Item',parent=self.itemRoot)
        else:
    ...
    def changeItem(self):
        if self.itemObject.itemVal == None:
            messagebox.showinfo('Uma Store','Select an Item to change',parent=self.itemRoot)
        else:
    ...
    def customize(self):
        ...
        obj.returnList[1]['command']=self.addItem
        obj.returnList[2]['command']=self.changeItem
